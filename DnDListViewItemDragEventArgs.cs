...
namespace DnDListViewSpace
{
  ...
  /// </summary>
  public class DnDListViewItemDragEventArgs : CancelListViewItemDragEventArgs
  {
    #region Public Constructors

    /// <summary>
    /// Initializes a new instance of the <see cref="DnDListViewItemDragEventArgs"/> class.
    /// </summary>
    ...
    public DnDListViewItemDragEventArgs(ListViewItem sourceItem, ListViewItem dropItem, int insertionIndex, InsertionMode insertionMode, int x, int y)
      : this()
    {
    ...
    /// Initializes a new instance of the <see cref="DnDListViewItemDragEventArgs"/> class.
    /// </summary>
    protected DnDListViewItemDragEventArgs()
    { }
